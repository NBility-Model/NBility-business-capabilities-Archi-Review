# NBility-business-capabilities-Archi-Review

This repo contains NBility-business-capabilities model version 2.3 in Archi format for review. The model is built using Archi. 
